# Generated by Django 2.2.20 on 2023-03-03 01:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateAdded', models.DateTimeField()),
                ('dateModified', models.DateTimeField(blank=True, default=None, null=True)),
                ('equivalentTo', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='studentGraph.Node')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentGraph.Problem')),
            ],
        ),
        migrations.CreateModel(
